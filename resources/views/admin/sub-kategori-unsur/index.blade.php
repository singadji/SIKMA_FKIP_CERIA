                    ...
                    <tbody>
                        ...
                        @foreach($item as $kategoriId => $rows)
                            ...
                            <tr class="table-primary">
                                <td colspan="4">
                                    <strong>{{ $kategori->nama_kategori_unsur ?? '-' }}</strong>
                                </td>
                            </tr>
                            ...
                            @foreach($rows as $row)
                                <tr>
                                    ...
                                    <td>└── {{ $row->nama_sub_unsur }}</td>

                                    <td class="text-center">
                                        <a href="{{ route('sub-kategori-unsur.edit', $row->uuid) }}"
                                        ...
                                        <a href="#"
                                           ...
                                           data-url="{{ route('sub-kategori-unsur.destroy', $row->uuid) }}">
