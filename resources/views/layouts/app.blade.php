...
$usession = Auth::check() ? Auth::user()->name : null;
...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>SIKMA FKIP CERIA - Admin & Dashboard</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="" name="description" />
        <meta content="Disominfo Kabupaten Tangerang" name="author" />
        ...
        <style>
            ...
            .overlay-gradient {
                position: absolute;
                inset: 0;
                background: linear-gradient(90deg, rgba(128,0,128,0.6), rgba(255,165,0,0.6));
                display: flex;
                align-items: center;
            ...
            <div class="main-content">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                {{ date('Y') }} © SIKMA FKIP CERIA
                            </div>
                            <div class="col-sm-6 text-sm-end">
                                Sistem Informasi Kepuasan Mahasiswa FKIP CERIA
                            </div>
                        </div>
                    </div>
                </footer>
